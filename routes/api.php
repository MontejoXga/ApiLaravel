...
Route::get('/categoria/{id}','App\Http\Controllers\CategoriaController@categoria_x_id');
...
Route::delete('/updatecategoria/{id}','App\Http\Controllers\CategoriaController@deletecategoria');
